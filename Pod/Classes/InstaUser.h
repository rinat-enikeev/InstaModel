...
@property (nullable, nonatomic, retain, readonly) NSSet<InstaCaption *> *captions;
@property (nullable, nonatomic, retain, readonly) NSSet<InstaComment *> *comments;
@property (nullable, nonatomic, retain, readonly) NSSet<InstaPost *> *likes;
@property (nullable, nonatomic, retain, readonly) NSSet<InstaPost *> *posts;
@property (nullable, nonatomic, retain, readonly) NSSet<InstaRelationship *> *relationships;
@property (nullable, nonatomic, retain, readonly) NSSet<InstaRelationship *> *relationshipRequests;
@property (nullable, nonatomic, retain, readonly) NSSet<InstaUserOnPost *> *onPostPhotos;
